 ...
 * This widget area is used to store random posts section.
 * @package HawkTheme
 * @since Mondeo 1.0
*******************************************************************************/
...
class Random_Posts_Widget extends WP_Widget{
	...
	function Random_Posts_Widget(){
		...
		$title_ops = __($themename.'&raquo; Random Posts','hawktheme');
		$widget_ops = array('classname'=>'widget-random-posts','description'=>__('This is a random posts list.','hawktheme'));
		$control_ops = array('width'=>450);
		$this->WP_Widget($shortname. '_random_posts',$title_ops,$widget_ops,$control_ops);
	}
	...
	function form($instance){
		$instance = wp_parse_args((array)$instance,array(
			'title' => __('Random Posts','hawktheme'),
			'showposts' => 3,
			'type' => 'blog',
			'terms' => '',
			'thumb' => 'true'
