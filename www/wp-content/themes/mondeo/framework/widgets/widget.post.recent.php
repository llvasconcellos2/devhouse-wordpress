 ...
 * This widget area is used to store recent posts section.
 * @package HawkTheme
 * @since Mondeo 1.0
*******************************************************************************/
...
class Recent_Posts_Widget extends WP_Widget{
	...
	function Recent_Posts_Widget(){
		...
		$title_ops = __($themename.'&raquo; Recent Posts','hawktheme');
		$widget_ops = array('classname'=>'widget-recent-posts','description'=>__('This widget will display a recent posts list.','hawktheme'));
		$control_ops = array('width'=>450);
		$this->WP_Widget($shortname. '_recent_posts',$title_ops,$widget_ops,$control_ops);
	}
	...
	function form($instance){
		$instance = wp_parse_args((array)$instance,array(
			'title' => __('Recent Posts','hawktheme'),
			'showposts' => 3,
			'type' => 'blog',
			'terms' => '',
			'thumb' => 'true'
