...
<section class="post-header">
	...
	<div class="entry-meta">
		...
		<?php if($categories): ?><span><?php _e('In','hawktheme'); ?> <?php echo get_the_term_list( $post->ID, 'slider', '', ',', '' ); ?></span><?php endif; ?>
...
<?php echo get_the_term_list( $post->ID, 'slider-tag', '<div class="tags">'. __('Tagged with: ','hawktheme'), ' , ', '</div>' ); ?>
<?php ht_the_author($author_info, 'slider-item'); ?>
</div><!--end post single-->
