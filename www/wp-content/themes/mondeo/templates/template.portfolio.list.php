<?php
 /*******************************************************************************
 * Template Is For: Portfolio Lists
 * @package HawkTheme
 * @since Mondeo 1.0
*******************************************************************************/
get_header();
...
?>
<?php
	if (has_nav_menu('portfolio menu')) {
...
?>
<div class="portfolio-lists post-lists">
<ul class="thumb-preloader thumb-fade thumb-move <?php echo $class; ?>">
<?php while (have_posts()) : the_post(); $count++; ?>
<li class="<?php if ($count % $num == 0) { echo 'last portfolio-'.$count; } else { echo 'portfolio-'.$count; } ?>">
		<?php 
			global $post, $key;
