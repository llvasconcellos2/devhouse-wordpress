...
function ht_all_css() {
	...
	echo '<link rel="stylesheet" type="text/css" media="screen" href="' .Skins_Url. '/css/common.css?ver='.$ver.'" />'."\n";
	echo '<link rel="stylesheet" type="text/css" media="screen" href="' .Skins_Url. '/css/main.css?ver='.$ver.'" />'."\n";
	echo '<link rel="stylesheet" type="text/css" media="screen" href="' .Skins_Url. '/css/ddsmoothmenu.css?ver='.$ver.'" />'."\n";
	echo '<link rel="stylesheet" type="text/css" media="screen" href="' .Skins_Url. '/css/slider.roundabout.css?ver='.$ver.'" />'."\n";
	echo '<link rel="stylesheet" type="text/css" media="screen" href="' .Skins_Url. '/css/slider.nivo.css?ver='.$ver.'" />'."\n";
	echo '<link rel="stylesheet" type="text/css" media="screen" href="' .Skins_Url. '/css/slider.kwicks.css?ver='.$ver.'" />'."\n";
	echo '<link rel="stylesheet" type="text/css" media="screen" href="' .Skins_Url. '/css/lists.css?ver='.$ver.'" />'."\n";
	echo '<link rel="stylesheet" type="text/css" media="screen" href="' .Skins_Url. '/css/single.css?ver='.$ver.'" />'."\n";
	echo '<link rel="stylesheet" type="text/css" media="screen" href="' .Skins_Url. '/css/comment.css?ver='.$ver.'" />'."\n";
	echo '<link rel="stylesheet" type="text/css" media="screen" href="' .Skins_Url. '/css/widgets.css?ver='.$ver.'" />'."\n";
	echo '<link rel="stylesheet" type="text/css" media="screen" href="' .Skins_Url. '/css/shortcodes.css?ver='.$ver.'" />'."\n";
