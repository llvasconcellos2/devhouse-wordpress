...
function et_divi_load_scripts_styles(){
	...
	wp_register_script( 'google-maps-api', add_query_arg( array( 'v' => 3, 'sensor' => 'false' ), is_ssl() ? 'https://maps-api-ssl.google.com/maps/api/js' : 'https://maps.google.com/maps/api/js' ), array(), $theme_version, true );
...
function et_pb_login( $atts, $content = null ) {
	...
	$redirect_url = 'on' === $current_page_redirect
		? ( is_ssl() ? 'https://' : 'https://' ) . $_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI']
		: '';
